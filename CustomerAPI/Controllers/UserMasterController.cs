...
namespace CustomerAPI.Controllers
{
    ...
    public class UserMasterController : ControllerBase
    {
        ...
        public UserMasterController(AdminDBContext learn_DB)
        {
            context = learn_DB;
        }
        ...
        {
            return context.TblUsers.FirstOrDefault(o => o.Userid == id);
        }
        ...
        {
            string result = string.Empty;
            var _emp = context.TblUsers.FirstOrDefault(o => o.Userid == id);
            if (_emp != null)
            {
                context.TblUsers.Remove(_emp);
                context.SaveChanges();
                result = "pass";
            }
            return new APIResponse { keycode = string.Empty, result = result };
