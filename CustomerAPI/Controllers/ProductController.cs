...
namespace CustomerAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(AdminDBContext learn_DB, IWebHostEnvironment environment)
        {
            context = learn_DB;
        ...
        {
            return context.TblProducts.FirstOrDefault(o => o.Code == id);
        }
        ...
        public IEnumerable<Product> GetProductwithimage()
        {
            ...
            var _product = context.TblProducts.ToList();
        ...
        {
            List<Product> _list = new List<Product>();
            var _product = context.TblProducts.FirstOrDefault(item => item.Code == id);
            if (_product != null)
            {
        ...
        public APIResponse Post([FromBody] TblProduct value)
        {
            ...
            try
            {
                var _emp = context.TblProducts.FirstOrDefault(o => o.Code == value.Code);
                if (_emp != null)
                {
        ...
        {
            string result = string.Empty;
            var _emp = context.TblProducts.FirstOrDefault(o => o.Code == id);
            if (_emp != null)
            {
                context.TblProducts.Remove(_emp);
                context.SaveChanges();
                result = "pass";
            }
            return new APIResponse { keycode = string.Empty, result = result };
